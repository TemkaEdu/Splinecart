...
public class SplinecartHud implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (world != null && client.player != null) {
            var origin = client.player.getMainHandItem().get(Splinecart.ORIGIN_POS.get());

            if (origin == null) {
                origin = client.player.getOffhandItem().get(Splinecart.ORIGIN_POS.get());
            }
            ...
            if (origin != null && client.hitResult instanceof BlockHitResult hit) {
                ...
                guiGraphics.drawCenteredString(client.font, text, w / 2, (h / 2) + 20, 0xFFFFFFFF);
            }
        }
    }
}
