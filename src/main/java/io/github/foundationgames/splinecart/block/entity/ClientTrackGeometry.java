...
public class ClientTrackGeometry extends TrackGeometry {
    ...
    public boolean render(PoseStack matrices,
        ...
        if (this.needsRebuild) {
            ...
            this.minSectionX = Math.min(currSec.x(), nextSec.x());
            this.minSectionY = Math.min(currSec.y(), nextSec.y());
            this.minSectionZ = Math.min(currSec.z(), nextSec.z());
            this.maxSectionX = Math.max(currSec.x(), nextSec.x());
            this.maxSectionY = Math.max(currSec.y(), nextSec.y());
            this.maxSectionZ = Math.max(currSec.z(), nextSec.z());
