...
public enum TrackRenderer {;
    ...
    public static BufferProvider immediateBuf(MultiBufferSource source, ResourceLocation texture, Function<ResourceLocation, RenderType> renderType) {
        return new ImmediateBufferProvider(source, texture, renderType);
    }

    public static BufferProvider vboBuf(VertexBuffer vbo, Tesselator tessellator) {
        return new VboBufferProvider(vbo, tessellator);
    }

    public record ImmediateBufferProvider(MultiBufferSource source, ResourceLocation texture, Function<ResourceLocation, RenderType> renderType) implements BufferProvider {
        @Override
    ...
    public static class VboBufferProvider implements BufferProvider {
        ...
        public VboBufferProvider(VertexBuffer vbo, Tesselator tessellator) {
            this.vbo = vbo;
        ...
        @Override
        public VertexConsumer buffer() {
            this.buffer = tessellator.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.NEW_ENTITY);
            return this.buffer;
        }
